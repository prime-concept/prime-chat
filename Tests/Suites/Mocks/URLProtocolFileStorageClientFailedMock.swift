//
//  URLProtocolFileStorageClientFailedMock.swift
//  ChatSDK
//
...
class URLProtocolFileStorageClientFailedMock: URLProtocol {

    /// what types of the request to handle
    override class func canInit(with request: URLRequest) -> Bool {
        request.url!.absoluteString.hasPrefix("invalid-url/files") ||
