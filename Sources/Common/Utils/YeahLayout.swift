...
extension UIView {
    ...
    func make(
        ...
        to v2: Any? = nil,
        _ constants: [CGFloat] = [],
        priorities: [UILayoutPriority] = [.required]
    ) -> [NSLayoutConstraint] {
    ...
    @discardableResult
    func make(
        _ a1: NSLayoutConstraint.Attribute,
        _ relation: [YeahRelation] = .equal,
...
extension Array where Element == YeahRelation {
